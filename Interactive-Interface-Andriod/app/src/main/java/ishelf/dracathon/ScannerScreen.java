...
import ishelf.dracathon.barcode.BarcodeReader;


public class ScannerScreen extends AppCompatActivity implements BarcodeReader.BarcodeReaderListener {
    private static final String TAG = ScannerScreen.class.getSimpleName();
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
               // Toast.makeText(getApplicationContext(), "Barcode: " + barcode.displayValue, Toast.LENGTH_SHORT).show();
                Intent i = new Intent(ScannerScreen.this, PDPScreen.class);
                i.putExtra("name", ""+barcode.displayValue);
                startActivity(i);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.scanner:
                Intent i = new Intent(ScannerScreen.this, ScannerScreen.class);
                i.putExtra("calling_activity", "ScannerScreen");
                startActivity(i);
                return true;

            case R.id.accountinfo:
                Intent i1 = new Intent(ScannerScreen.this, UserScreen.class);
